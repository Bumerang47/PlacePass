"""
Django settings for PlacePass project.
...
WSGI_APPLICATION = 'PlacePass.wsgi.application'
...
SOCIAL_AUTH_FACEBOOK_KEY = os.environ.get('AUTH_FACEBOOK_KEY', '')
